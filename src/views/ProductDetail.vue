    ...
    <div class="detail-content">
      <div class="detail-swipe-wrap">
        <van-swipe class="my-swipe" indicator-color="#1baeae">
          <van-swipe-item v-for="(item, index) in detail.goodsCarouselList" :key="index" style="text-align:center;">
            <img :src="$filters.prefix(item)" alt="" style="width:300px;height:300px;">
          </van-swipe-item>
        </van-swipe>
      </div>
